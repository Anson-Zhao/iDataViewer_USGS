                        ...
                        if (!resp.error) {
                            ...
                            for (var i = 0; i < resp.data.length; i++) {
                                ...
                                if (i === resp.data.length - 1) {
                                    ...
                                    HeatMapLayer._gradient = {0: "#000000", 0.4: "#ffffff", 0.5: "#0ffff0", 0.7: "#00ff00", 0.9: "#ffff00", 1: "#ff0000"};
                    ...
                    success: function (resp) {
                        if (!resp.error) {
                            ...
                            for (var i = 0; i < resp.data.length; i++) {
                                ...
                                if (i === 0 || resp.data[i].p_name !== resp.data[i - 1].p_name) {
                                    autoSuggestion.push({"value": resp.data[i].p_name, "lati": resp.data[i].latitude, "long": resp.data[i].longitude, "i": wwd.layers.length - 1});
                                } else {
                                    autoSuggestion[autoSuggestion.length - 1].i += ('-' + (wwd.layers.length - 1));
                                }
