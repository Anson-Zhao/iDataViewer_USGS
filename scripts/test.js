    ...
    function (WorldWind,
        ...
        $(document).ready(function() {
            $(function () {
                    ...
                    success: function (resp) {
                        if (!resp.error) {
                            ...
                            for (var i = 0; i < resp.data.length; i++) {
                                ...
                                data[i] = new WorldWind.MeasuredLocation(resp.data[i].ylat, resp.data[i].xlong, 0.5);
                                ...
                                if (i === resp.data.length - 1) {
                                    ...
                                    HeatMapLayer._gradient = {0: "#000000", 0.4: "#ffffff", 0.7: "#00ff00", 0.9: "#ffff00", 1: "#ff0000"};
                                    HeatMapLayer._radius = 6;
                ...
                var latitude = getRandomInRange(30, 40, 3);
                var longitude = getRandomInRange(10, 30, 3);
                var measure = getRandomInRange(1, 100, 3);
                ...
                var HeatMapLayer2 = new WorldWind.HeatMapLayer("Heatmap", locations);
                HeatMapLayer2.scale = ['#000000', '#ffffff', '#00ff00', '#ffff00', '#ff0000'];
                HeatMapLayer2._gradient = {0: "#000000", 0.4: "#ffffff", 0.7: "#00ff00", 0.9: "#ffff00", 1: "#ff0000"};
                HeatMapLayer2._radius = 6;
                HeatMapLayer2._incrementPerIntensity = 10;
                console.log(HeatMapLayer2);

                wwd.addLayer(HeatMapLayer2);

                var newLat = "latitude=" + latitude.serialize();
                var newLon = "longitude=" + longitude.serialize();
                var newMeasure = "measure=" + measure.serialize();

                $.ajax({
                    url: '/testLocations',
                    method: "POST",
                    data: newLat + "&" + newLon + "&" + newMeasure,
                    dataType: 'json',
                    success: function (result) {
                        console.log(newLat + "&" + newLon + "&" + newMeasure);
                    }
                });
